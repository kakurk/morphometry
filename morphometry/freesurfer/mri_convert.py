...
def mri_convert_382e322e30(input, output, log, **kwargs):
    '''
    FreeSurfer 8.2.0 mri_convert
    '''
...
def mri_convert_372e342e31(input, output, log, **kwargs):
    '''
    FreeSurfer 7.4.1 mri_convert
    '''
    mri_convert = commons.which('mri_convert')
    if not mri_convert:
        raise commons.CommandNotFoundError('could not find mri_convert')
