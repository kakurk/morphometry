...
def wm_anat_snr_382e322e30(input, output, log,  **kwargs):
    '''
    FreeSurfer 8.2.0 wm-anat-snr
    '''
...
def wm_anat_snr_372e342e31(input, output, log,  **kwargs):
    '''
    FreeSurfer 7.4.1 wm-anat-snr
    '''
    wm_anat_snr = commons.which('wm-anat-snr')
    if not wm_anat_snr:
        raise commons.CommandNotFoundError('could not find wm-anat-snr')
