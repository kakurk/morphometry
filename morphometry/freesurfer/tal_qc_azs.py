...
def tal_qc_azs_382e322e30(input, output, log,  **kwargs):
    '''
    FreeSurfer 8.2.0 tal_QC_AZS
    '''
...
def tal_qc_azs_372e342e31(input, output, log,  **kwargs):
    '''
    FreeSurfer 7.4.1 tal_QC_AZS
    '''
    tal_qc_azs = commons.which('tal_QC_AZS')
    if not tal_qc_azs:
        raise commons.CommandNotFoundError('could not find tal_QC_AZS')
