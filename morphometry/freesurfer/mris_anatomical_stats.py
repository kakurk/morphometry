...
def mris_anatomical_stats_382e322e30(input, output, log,  **kwargs):
    '''
    FreeSurfer 8.2.0 mris_anatomical_stats
    '''
...
def mris_anatomical_stats_372e342e31(input, output, log,  **kwargs):
    '''
    FreeSurfer 7.4.1 mris_anatomical_stats
    '''
    mris_anatomical_stats = commons.which('mris_anatomical_stats')
    if not mris_anatomical_stats:
        raise commons.CommandNotFoundError('could not find mris_anatomical_stats')
